...
const Home = () => {
	...
	const email = 'saber.mahmoud702@eng-st.cu.edu.eg';
	const whatsappNumber = '+201119899016';

	const { data: githubData } = useSWR('https://api.github.com/users/SaberMahmoud1',fetcher,{ revalidateOnMount: true, dedupingInterval: 0 });
		...
		<div className="min-h-screen flex items-center justify-center px-4 mt-7 sm:mt-0 md:mt-3 lg:mt-5">
			<div className="text-center relative z-10 max-w-4xl mx-auto">
				...
				<motion.h1
					...
					transition={{ duration: 0.8 }}
				>
					I design digital circuits & write embedded code.
				</motion.h1>
				...
				>
					Experienced in RTL design, embedded C, and hardware-software co-design for real-time systems.
				</motion.p>
				...
				>
					<div className="flex justify-center space-x-3 sm:space-x-4">
						<a
							href="/files/cv_pdf/Saber_Mahmoud(CV).pdf"
							target="_blank"
