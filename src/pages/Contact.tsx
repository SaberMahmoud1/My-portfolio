	...
	const contactInfo = [
		{
			...
			label: 'Email',
			value: 'saber.mahmoud702@eng-st.cu.edu.eg',
			link: 'mailto:saber.mahmoud702@eng-st.cu.edu.eg'
		},
		{
			icon: <Phone className="w-5 h-5" />,
			label: 'Phone',
			value: '+201119899016',
			link: 'tel:+201119899016'
		},
		{
	...
	const socialLinks = [
		{
			...
			label: 'GitHub',
			link: 'https://github.com/SaberMahmoud1'
		},
		{
			icon: <Linkedin className="w-5 h-5" />,
			label: 'LinkedIn',
			link: 'https://linkedin.com/in/saber-mahmoud-2450b0246'
		},
		{
			icon: <MessageCircle className="w-5 h-5" />,
			label: 'WhatsApp',
			link: 'https://wa.me/+201119899016'
		}
	];
