...
const experiences = [
	...
	type: "Internship",
	image: "/experience/si-vision.png",
	certificateUrl: "/files/experience_pdf/SI-Vision-Certificate.pdf",
	description: [
		"Completed full-time on-site internship under the supervision of experienced engineers in a professional environment",
		"Worked on a DMA project with AXI4 interface using SystemVerilog and SpyGlass for linting and RTL verification",
		"Accessed SI-Vision Academy and internal tools, culminating in a final project presentation showcasing implementation and results"
	]
}
];
