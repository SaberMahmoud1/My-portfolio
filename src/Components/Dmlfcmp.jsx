...
export default function Dmlfcmp({imgd}) {
    ...
    return (
      ...
      <Fade delay={200}><Dblue title={"Design Lane Detection System:"} para={"Designed a complete RTL lane detection system that processes road images through RGB-to-grayscale conversion, averaging filter, Sobel edge detection, and decision logic to identify lane count, boundaries, and current lane position."} img={lane} linka={"https://github.com/SaberMahmoud1/lane_detection_system"} /> </Fade>
      <Fade delay={200}><Dyellow title={"Design and Verification for Ultrasonic System"} para={"I have contributed in an ultrasonic-zynq based-system with strongly participating in the top module UVM environment developing along with the stimulus generation. Verification of the system decoder using SV and SVA. Design of the receiving block in the control unit besides the storage RAM for the same block. The waveforms were generated using QuestaSim."} img={sonar} linka={"https://github.com/SaberMahmoud1/Ultrasonic-zynq7000-based-system"} /> </Fade>
