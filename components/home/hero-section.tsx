		...
		<section className="relative overflow-hidden">
			...
			<div className="container relative z-10 px-4 py-20 md:py-32 flex flex-col items-center justify-center min-h-[90vh]">
				...
				>
					...
					>
						<span className="text-gradient">Saber Mahmoud's</span> Portfolio
					</motion.h1>
					...
					>
					A showcase of my projects, skills, and achievements in digital design, hardware verification, and embedded systems as an Electronics and Electrical Communications Engineer.
					</motion.p>
					...
					>
						...
						<Button size="lg" variant="outline" asChild>
							<Link href="/files/cv_pdf/Saber_Mahmoud.pdf" download>
